export const mysql2 = [
    ...
    {
        index: 16,
        question: "Какво не  включва Вход за машинно обучение ?",
        choices: [
            "Концепции – това, което искаме да научим (напр. вид животно)",
            "Примери (instances) – конкретни данни, по които се учи (напр. тигър, слон)",
            "Класификация – отнасяне към категории",
            "Атрибути – характеристики (напр. цвят, тегло, брой крака)"

        ],
        correctAnswer: "Класификация – отнасяне към категории"
    },
    {
        index: 17,
        question: "Какво не е типова задача в машинно обучение ?",
        choices: [
            "Концепции – това, което искаме да научим (напр. вид животно)",
            "Класификация – отнасяне към категории",
            "Асоцииране – намиране на зависимости",
            "Клъстериране – групиране по подобие",
            "Числово прогнозиране – предсказване на стойности"

        ],
        correctAnswer: "Концепции – това, което искаме да научим (напр. вид животно)"
    },
    {
        index: 18,
        question: "Какво не е типов атрибут?",
        choices: [
            "Номинални – имена (напр. цвят)",
            "Класификация – отнасяне към категории",
            "Ординални – наредени (напр. оценка: ниска, средна, висока)",
            "Интервални – числа без абсолютна нула (напр. температура)",
            "Съотношения (ratio) – числа с нула (напр. тегло, възраст)"
    ...
    {
        index: 19,
        question: "Какво не е част от обработка на входа?",
        choices: [
            "ARFF – файлов формат за данни",
            "Класификация – отнасяне към категории",
            "Редки данни – повечето стойности са нули",
            "Липсващи/грешни стойности – трябва да се обработят",
            "Небалансирани данни – някои класове са много повече от други",
            "Опознаване на данните – важно преди обучение"
