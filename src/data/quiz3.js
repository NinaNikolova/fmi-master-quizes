...
export const mysql3 = [
    ...
    },
    {
        ...
        choices: [
            ...
            "By 1990, use cases began to be recognized as one of the most common practices for capturing functional requirements.",
            "In 1992, Jacobson published the book 'Object-Oriented Software Engineering: A Use Case Driven Approach.'",
            "In 2000, use case diagrams were first included in the Unified Modeling Language (UML) and the Rational Unified Process (RUP).",
            "1995 - use case diagrams included into Unified Modeling Language (UML) and the Rational Unified Process (RUP)"
        ],
        correctAnswer: "In 2000, use case diagrams were first included in the Unified Modeling Language (UML) and the Rational Unified Process (RUP).",
        imageURL: null
    },
    {
        index: 26,
    ...
    },
    {
        ...
        correctAnswer: "Actors have to be people only.",
        imageURL: null
    },
    {
        index: 29,
        ...
        choices: [
            ...
            "The specific coding standards to be followed during development.",
            "The interests the actor has in the system.",
    ...
    },
    {
        ...
        choices: [
            ...
            "A use case only focuses on the technical specifications of the system.",
        ],
        correctAnswer: "A use case only focuses on the technical specifications of the system.",
        imageURL: null
    },
    {
        index: 31,
    ...
    },
    {
        ...
        correctAnswer: "User interface design specifications.",
        imageURL: null
    },
    {
        index: 33,
    ...
    },
    {
        ...
        choices: [
            ...
            "The client in a realization represents the specification, while the supplier represents the implementation.",
            "Realization can be used to model stepwise refinement, optimizations, transformations, templates, model synthesis, framework composition"
        ],
        correctAnswer: "The client in a realization represents the specification, while the supplier represents the implementation.",
        imageURL: null
    },
    {
        index: 54,
    ...
    },
    {
        ...
        choices: [
            ...
            "Functional and non-functional requirements include usability, reliability, and scalability.",
            "The requirements specification serves as a contract between clients and developers.",
            "Realism means the system requirements do not need to consider constraints.",
            "Traceability – each system function can be traced back to its corresponding set of req’s",
            "Verifiability and validability – after construction phase, repeatable tests can be built for proving the system fulfils the req. spec."

        ],
        correctAnswer: "Realism means the system requirements do not need to consider constraints.",
        imageURL: null
    },
    {
        index: 58,
