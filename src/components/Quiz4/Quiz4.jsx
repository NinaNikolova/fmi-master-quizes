...
import QuizSelector from "../Quiz4/QuizSelector";
import Result from "../Result";
import Question from "../Question";
import { getQuestions } from "../../utils/getQuestions";
import { calculateResult } from "../../utils/calculateResult";
import { mysql1 } from "../../data4/quiz1";
import { mysql2 } from "../../data4/quiz2";
import { mysql3 } from "../../data4/quiz3";
import { mysql4 } from "../../data4/quiz4";
import { mysql5 } from "../../data4/quiz5";
import { mysql6 } from "../../data4/quiz6";
import { mysql7 } from "../../data4/quiz7";
...
const Quiz = () => {
  ...
  const questions = getQuestions(selectedQuiz, { mysql1, mysql2, mysql3, mysql4, mysql5, mysql6, mysql7,  mysql8, mysql9 });
  ...
  return (
    <div className="quiz-container">
      <div className="heading">
        <h2>Софтуерни технологии- напреднали </h2>
        <HomeLink />
      </div>
