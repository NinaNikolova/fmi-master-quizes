export const mysql3 = [
  ...
  },
  {
    ...
    choices: [
      ...
      "Лесно имплементиране на интерактивни приложения",
      "Филтрите могат да се третират като черни кутии"
    ],
    correctAnswer: "Лесно имплементиране на интерактивни приложения",
    imageURL: null
  },
  {
    index: 3,
  ...
  {
    index: 12,
    question: "Какво определят архитектурните стилове според материала?",
    choices: [
  ...
  {
    index: 20,
    question: "Според материала, как най-често се прилагат архитектурните стилове в практиката?",
    choices: [
